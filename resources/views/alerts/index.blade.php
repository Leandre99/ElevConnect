...
@section('content')
    <div class="container mt-4">
        ...
        <!-- Information cliquable pour l'éleveur -->
        @if (auth()->user()->role === 'Eleveur')
            <button class="btn btn-sm btn-outline-info mb-3" data-bs-toggle="modal" data-bs-target="#infoModal">
                <i class="bi bi-info-circle"></i> Information
            </button>
        @endif

        <!-- Modal avec le message -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Vous devez consulter votre boîte mail pour voir les meetings planifiés par le vétérinaire. Ces meetings sont essentiels pour suivre les alertes et planifier les actions nécessaires pour vos animaux.</p>
                    </div>
                        ...
                        <div class="card shadow-sm border-start border-4" style="border-left-color: {{ $borderColor }}">
                            <div class="card-body d-flex flex-column">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="badge {{ $priorite === 'Haute' ? 'bg-danger' : ($priorite === 'Moyenne' ? 'bg-warning text-dark' : 'bg-success') }}">
                                        Priorité : {{ $priorite }}
                                    </span>
